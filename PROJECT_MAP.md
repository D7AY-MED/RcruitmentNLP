...
| **Pool / Offer (job_pools)** | id, hr_id (FK), title, description, must_have_skills, nice_to_have_skills, soft_skills, deal_breakers, responsibilities, notes, public_token, status, years_experience, experience_range, seniority_level, languages, education_level, contract_type, location, gemini_store_name, created_at | Job pools/offers with unique tokenized links |
...
| **Candidate Summary (Candidate_summaries)** | id, candidate_id (FK), Candidate_name, summary, last_updated, phone, score, gemini_store_name | Factual summary of candidate's interview answers along with a granular match score (0.00 - 100.00) |
