...
def get_pool_details(pool_id: str) -> dict | None:
    ...
    result = _supabase.table("job_pools").select(
        "title, main_mission, must_have_skills, nice_to_have_skills, soft_skills, "
        "deal_breakers, responsibilities, description, languages, years_experience, "
        "notes, education_level, location, experience_range, seniority_level, contract_type"
